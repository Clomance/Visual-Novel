use graphics::draw_state::{self,Stencil,Blend};
...
// "Украденные" из glium_graphics функции

pub fn convert_draw_state(draw_state:&draw_state::DrawState)->glium::draw_parameters::DrawParameters<'static>{
...
pub fn convert_scissor(rect:Option<[u32;4]>)->Option<glium::Rect>{
    rect.map(|rect|{
        // scissor: [x, y, w, h]
        glium::Rect{
            left:rect[0] as u32,
    ...
    match stencil {
        ...
        Some(stencil) => {
            ...
            glium::draw_parameters::Stencil {
                ...
                fail_operation_counter_clockwise: stencil_test_fail_operation,
